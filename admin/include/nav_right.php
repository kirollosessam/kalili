            ...
            <div class="row">
                <div class="predefined_styles">
                    <div class="swichermainleft">
                        ...
                        <div class="pl-3 pr-3">
                            <a class="btn btn-primary btn-block" href="horizontalmenu.html">
                                Horizontal-menu
                            </a>
                            <a class="btn btn-secondary btn-block" href="verticalmenu.html">
                                Vertical-menu
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swichermainleft">
                        <h4>Leftmenu Versions</h4>
                        <div class="switch_section">
                            <div class="switch-toggle d-flex">
                                <span class="mr-auto">Default Leftmenu </span>
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch15" class="onoffswitch2-checkbox">
                                    <label for="myonoffswitch15" class="onoffswitch2-label"></label>
                                </div>
                            </div>
                            <div class="switch-toggle d-flex">
                                <span class="mr-auto">Boxed</span>
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch17" class="onoffswitch2-checkbox">
                    ...
                    <div class="swichermainleft">
                        <div class="switch_bg-img">
                            <div class=" d-flex">
                                <span class="mr-auto">Left-menu Bg-Image</span>
                                <div class="onoffswitch2"><input type="checkbox" name="checkbox" id="myonoffswitch-1" class="onoffswitch2-checkbox">
                                    <label for="myonoffswitch-1" class="onoffswitch2-label"></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="skin-theme-switcher">
                        ...
                        <div class="swichermainleft border-top  mt-2 text-center">
                            <div class="p-3">
                                <a href="https://laravel.spruko.com/volgh/" class="btn btn-primary btn-block mt-0">View Demo</a>
                                <a href="https://themeforest.net/item/volgh-admin-dashboard-html-template/24716170" class="btn btn-secondary btn-block">Buy Now</a>
