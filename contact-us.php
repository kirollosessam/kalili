<?php include "include/header.php";?>
        ...
        <div class="pt-[80px] lg:pt-[120px]">
            <div class="container">
                <form id="contact-form" action="https://htmldemo.net/bery/bery/assets/php/contact.php" method="post">
                ...
                <div class="grid col-span-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-[30px] mb-[-30px]">
                    ...
                    <div class="flex hover:drop-shadow-[0px_16px_10px_rgba(0,0,0,0.1)] hover:bg-[#F5F9F8] transition-all p-[20px] xl:p-[35px] rounded-[8px] mb-[30px] group">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="font-light text-[18px] lg:max-w-[230px]">2104 Charmaine Lane Amarillo, New York</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="grid sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-x-5 md:gap-x-[30px] mb-[-30px]">
                ...
                <div class="text-center group mb-[30px]">
                    <div class="relative rounded-[6px_6px_0px_0px]">
                        <a href="agent-details.html">
                            <img src="assets/images/team/person1.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Amelia Margaret">
                        </a>
                ...
                <div class="text-center group mb-[30px]">
                    <div class="relative rounded-[6px_6px_0px_0px]">
                        <a href="agent-details.html">
                            <img src="assets/images/team/person2.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt="Stephen Kelvin">
                        </a>
                        <ul class="flex flex-col absolute w-full top-[30px] left-0 overflow-hidden">
                            <li class="translate-x-[0px] group-hover:translate-x-[30px] opacity-0 group-hover:opacity-100 transition-all duration-300 mb-[15px]">
                                <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
                ...
                <div class="text-center group mb-[30px]">
                    <div class="relative rounded-[6px_6px_0px_0px]">
                        <a href="agent-details.html">
                            <img src="assets/images/team/person3.png" class="w-auto h-auto block mx-auto" loading="lazy" width="215" height="310" alt=" Michael Richard">
                        </a>
                        <ul class="flex flex-col absolute w-full top-[30px] left-0 overflow-hidden">
                            <li class="translate-x-[0px] group-hover:translate-x-[30px] opacity-0 group-hover:opacity-100 transition-all duration-300 mb-[15px]">
                                <a href="#" aria-label="svg" class="w-[26px] h-[26px] transition-all rounded-full bg-[#FFF6F0] flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-[#494949] hover:text-[#3B5998]">
